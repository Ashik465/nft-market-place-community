...
const ThirdColum = () => {
    return (
        <div className='p-2 md:p-0'>
            ...
            <h1 style={{ fontFamily: "Roboto, sans-serif" }} className=" font-bold text-2xl">Top Collections over </h1>
            <p  style={{
              fontFamily: "DM Sans, sans-serif",
            }} className="text-[#3D00B7] text-xl font-bold pb-5">Last 7 days</p>
            {/* number start */}
            <div className="flex items-center gap-5 p-4 border-b-2">
                <h1  style={{
              fontFamily: "DM Sans, sans-serif",
            }} className=' font-bold text-2xl'>1</h1>
            ...
            <div className="flex items-center gap-5 p-4 border-b-2">
                <h1  style={{
              fontFamily: "DM Sans, sans-serif",
            }} className=' font-bold text-2xl'>2</h1>
                <div >
                    <img src={prof2} alt="" />
            ...
            <div className="flex items-center gap-5 p-4 border-b-2">
                <h1  style={{
              fontFamily: "DM Sans, sans-serif",
            }} className=' font-bold text-2xl'>3</h1>
                <div >
                    <img src={prof3} alt="" />
            ...
            <div className="flex items-center gap-5 p-4 border-b-2">
                <h1  style={{
              fontFamily: "DM Sans, sans-serif",
            }} className=' font-bold text-2xl'>4</h1>
                <div className='relative'>
                    <img src={prof4} alt="" />
                    <img className='absolute -top-2 -right-1' src={verify} alt="" />
                </div>
            ...
            <div className="flex items-center gap-5 p-4 ">
                <h1  style={{
              fontFamily: "DM Sans, sans-serif",
            }} className=' font-bold text-2xl'>5</h1>
                <div >
                    <img src={prof5} alt="" />
